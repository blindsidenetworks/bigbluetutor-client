    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all([
            ...
            (() => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                let appId;
                const projectFile = env.project.directory ? yield project.load() : undefined;
                if (projectFile) {
                    appId = projectFile.app_id;
                }
                const now = new Date().toISOString();
                const isLoggedIn = yield env.session.isLoggedIn();
                const { req } = yield client.make('POST', `${config.urls.api !== 'https://api.ionic.io' ? 'https://api.ionicjs.com' : ''}/events/metrics`); // TODO: full URL is temporary
                const metric = {
