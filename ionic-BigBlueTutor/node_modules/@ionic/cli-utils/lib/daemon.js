...
function createCommServer(env) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const [express, bodyParser] = yield Promise.all([Promise.resolve().then(function () { return require('express'); }), Promise.resolve().then(function () { return require('body-parser'); })]);
        const { PROJECT_FILE, Project } = yield Promise.resolve().then(function () { return require('../lib/project'); });
        const app = express();
        app.use(bodyParser.json());
        app.post('/events/command', (req, res) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { sendCommand } = yield Promise.resolve().then(function () { return require('./telemetry'); });
