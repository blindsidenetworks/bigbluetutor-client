...
class PackageClient {
    ...
    getBuild(id, { fields = [] }) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const { req } = yield this.client.make('GET', `/package/builds/${id}`);
    ...
    getBuilds({ page = 1, pageSize = 25 }) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { req } = yield this.client.make('GET', '/package/builds');
    ...
    queueBuild({ platform, mode, zipUrl, projectId, profileTag }) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { req } = yield this.client.make('POST', '/package/builds');
            req
    ...
    requestProjectUpload() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { req } = yield this.client.make('POST', '/package/projects');
    ...
    uploadProject(project, zip, { progress }) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return aws_1.s3SignedUpload(this.client.config, project.presigned_post, zip, { progress });
        });
    }
    downloadBuild(build, dest, { progress }) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const { req } = yield http_1.createRequest(this.client.config, 'get', build.url);
