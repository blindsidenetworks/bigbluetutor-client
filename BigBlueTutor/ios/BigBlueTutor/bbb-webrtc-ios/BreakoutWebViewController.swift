    ...
    func userContentController(_ userContentController: WKUserContentController, didReceive message: WKScriptMessage) {
        ...
        case "goToRoom":
            ...
            if let url = messageObject["url"] as? String {
                ...
                BigBlueButtonViewController.bigBlueButtonViewController!.requestBreakoutRooms()
            }
        ...
        case "leaveRoom":
            ...
            self.dismiss(animated: false, completion: nil)
            if let meetingid = messageObject["meetingId"] as? String {
                BigBlueButtonViewController.rooms.removeValue(forKey: meetingid)
            }
//            for meetingId in BigBlueButtonViewController.rooms.keys {
//                if (self == BigBlueButtonViewController.rooms[meetingId]) {
//                    BigBlueButtonViewController.rooms.removeValue(forKey: meetingId)
//                    break
//                }
//            }
